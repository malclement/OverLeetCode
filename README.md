...
8. [Hand of Straights](https://leetcode.com/problems/hand-of-straights)
9. [Score After Flipping Matrix](https://leetcode.com/problems/score-after-flipping-matrix)
10. [Path with Maximum Gold](https://leetcode.com/problems/path-with-maximum-gold)
11. [Delete Leaves With a Given Value](https://leetcode.com/problems/delete-leaves-with-a-given-value)
12. [Append Characters to String to Make Subsequence](https://leetcode.com/problems/append-characters-to-string-to-make-subsequence)
13. [Number of Beautiful subsets](https://leetcode.com/problems/the-number-of-beautiful-subsets)

#### Hard

1. [Median of Two Sorted Arrays](https://leetcode.com/problems/median-of-two-sorted-arrays)
2. [Find the Safest Path in a Grid](https://leetcode.com/problems/find-the-safest-path-in-a-grid)
